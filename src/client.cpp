...
const int LEVEL_HEIGHT = 1320;   //2880/36   /22

//Tile constants
const int TILE_WIDTH = 60;
const int TILE_HEIGHT = 60;
const int TOTAL_TILES = 484;
...
class Bax
{
	public:
		...
		void setBax(int mVexX_1,int mVexY_1){
		mVexX = mVexX_1;
		mVexY = mVexY_1;}
...
bool init()
{
	...
	else
	{
		...
		//Create window
		gWindow = SDL_CreateWindow( "Robot Wars", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN );
		if( gWindow == NULL )
		{
...
bool loadMedia( Tile* tiles[] )
{
	...
	//Load dot texture
	if( !gDotTexture.loadFromFile( "res/player/down_user.png" ) )
	{
